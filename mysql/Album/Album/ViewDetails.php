<?php 
  ...
  if (isset($_GET['detailsName'])) {
      $detailsName=$_GET['detailsName'];
      $CategoryWiseViewQuery=CategoryWise::categoryWiseView($detailsName);
  }
...
<?php while ($CategoryWiseViewQueryFetch=mysqli_fetch_assoc($CategoryWiseViewQuery)) { ?>

        <div class="col-md-6">
          <div class="card mb-6 shadow-sm">
            <img src="admin/posts/<?php echo $CategoryWiseViewQueryFetch['image']; ?>" style="height: 350px;"><br>
            <div class="card-title">
               <h3 class="text-center mb-0"><?php echo $CategoryWiseViewQueryFetch['caption']; ?></h3>
            </div><span style="border-bottom: 1px solid gray;"></span>
            <div class="card-body">
              <p class="card-text"><?php echo $CategoryWiseViewQueryFetch['short_description']; ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-info"><a href="viewIt.php?viewit=<?php echo $CategoryWiseViewQueryFetch['id']; ?>" style="color: white;">View more..</a></button>
                </div>

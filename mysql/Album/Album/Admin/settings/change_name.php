    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            <a class="nav-link active" href="change_name.php">
              <span data-feather="user"></span>
              Change Website Name <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="change_email.php">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-sm table-bordered text-center">
                   <tr>
                      <th><h1>Website Name</h1></th>
                      <th><h1>Change Website Name</h1></th>
                   </tr>

                   <tr>
                     <td><h2 class="mt-4"><?php echo $viewSiteInfoQueryFetch['site_name']; ?></h2></td>
                     <td>
                  <form action="" method="post" class="mt-2">
                      <input class="form-control" type="text" name="site_name" placeholder="Input a Website name" required> <br>

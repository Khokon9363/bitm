            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-sm table-bordered text-center">
                   <tr>
                      <th><h1>Current Password</h1></th>
         <form action="" method="post" class="mt-2">
                      <td><h3 class="mt-4"><?php echo $viewUsersInfoQueryFetch['password']; ?></h3></td>
                   </tr>
                   ...
                   <tr>
                     ...
                     <td><br>
                      ...
                      <input class="form-control" type="password" name="password" placeholder="Input a Strong Password" required> <br>

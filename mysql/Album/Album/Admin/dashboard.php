...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas> <hr>
     ...
     <script>window.jQuery || document.write('<script src="../vendor/bootstrap/js/jquery.js"><\/script>')</script>

<?php 
  ...
  $viewSliderQuery=Slider::viewSlider();
  
  $resultMassage='';
  if (isset($_GET['sliderId'])) {
      $sliderId=$_GET['sliderId'];
      $resultMassage=Slider::PublicationManagmentOfSlider($sliderId);
  }
...
<div class="container-fluid">
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="view_slider.php">
              <span data-feather="eye"></span>
              View Slider <span class="sr-only">(current)</span>
            </a>
          </li><span style="border-bottom: 1px dashed black;"></span>
        </ul>
 ...
 <?php
  ...
  while ($viewSliderQueryFetch=mysqli_fetch_assoc($viewSliderQuery)) { ?>
                   <tr>
                      <td><?php echo $x++;?></td>
                      <td><?php echo $viewSliderQueryFetch['carousel_caption']; ?></td>
                      <td><img src="<?php echo $viewSliderQueryFetch['carousel_image']; ?>" height="150px" width="200px"></td>
                      <td><?php if ($viewSliderQueryFetch['carousel_status']==1) {
                                echo "Published";
                      } else {
                                echo "Unpublished";
                      }
                       ?></td>
                    <td><a href="?sliderId=<?php echo $viewSliderQueryFetch['id']; ?>">
                        <?php if ($viewSliderQueryFetch['carousel_status']!=1) {
                                echo "Published";
                      } else {
                                echo "Unpublished";
                      }

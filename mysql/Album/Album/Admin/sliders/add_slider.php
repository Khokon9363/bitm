<?php 
  ...
  $addSliderMassage='';
  if (isset($_POST['btn'])) {
      $addSliderMassage=Slider::addSlider($_POST);
  }
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="add_slider.php">
              <span data-feather="plus-circle"></span>
              Add Slider <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="view_slider.php">
              <span data-feather="eye"></span>
              View Slider
            </a>
          </li><span style="border-bottom: 1px dashed black;"></span>
      ...
      <div class="col-sm-6 m-auto">
        <h3 class="text-center text-success"><?php echo $addSliderMassage; ?></h3>
         <div class="card">
            <div class="card-header text-center"><h3><i><b>Add a slider Image</b></i></h3></div>
            <div class="card-body">

              <form action="" method="post" enctype="multipart/form-data">
                 <div class="form-group">
                    <input type="text" name="carousel_caption" class="form-control" placeholder="Choose a caption" required>
                 </div>
                 <div class="form-group">
                    <input type="file" name="carousel_image" required>
                 </div>
                 <div class="form-group">
                    <input type="radio" name="carousel_status" value="1"> Published <br>
                    <input type="radio" name="carousel_status" value="0"> Unpublished
                 </div>
                 <div class="form-group">
                    <input type="submit" name="btn" class="btn btn-lg btn-primary btn-block" value="Add Slider">
                 </div>
            </form>
